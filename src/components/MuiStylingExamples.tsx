...
export const MuiStylingExamples = () => {
    ...
    const [multiSelectValue3, setMultiSelectValue3] = useState<Array<Animals>>([])
    ...
    const handleOnMultiSelect3 = (event: React.ChangeEvent<HTMLInputElement>) => {

        setMultiSelectValue3((prevSelectValue: Array<Animals>) => {
            ...
            * */
            ...
            console.log(`handleOnMultipleSelect3 previous value is ${prevSelectValue}, new value is ${event.target.value}`);
            return selectedValues as Array<Animals>

        })

    } //handleOnMultipleSelect3
    ...
    return (
        ...
        <>
            ...
            <Grid container spacing={2} justifyContent="flex-start" sx={{ border: "2px black solid" }}>
                ...
                <Grid size={1}></Grid>
                <Grid size={5}>
                    <Typography component='span' align="left" sx={{ fontWeight: 'bold', fontSize: '1.2rem' }}>Override colorSecondary slot of MuiButton</Typography>
                    <Typography variant="body1" sx={{ my: 3 }} align="left">
                        Per https://mui.com/material-ui/customization/how-to-customize/, this is defined as a slot<br />
                        sx=&#123;&#123; '&.MuiButton-colorSecondary': &#123; color:'green' &#125;&#125;&#125;<br />
                    </Typography>
 ...
 <Grid size={2}>
                    <Box>
                        ...
                        <TextField
                            ...
                            helperText="Multi select control"
                            select
                            onChange={handleOnMultiSelect3}
                            fullWidth
                            slotProps={{
                                select: { multiple: true }
                            }}
                        >
                            <MenuItem value="bird" sx={{
                                 '&.Mui-selected.MuiMenuItem-root' :  { backgroundColor:'rgba(151, 13, 43, 0.15)' } 
                            ...
                            <MenuItem value="dog" sx={{
                                 '&.Mui-selected' :  { backgroundColor:'rgba(23, 64, 230, 0.15)' } 
                ...
                <Grid size={1}></Grid>
                <Grid size={5}>
                    <Typography component='span' align="left" sx={{ fontWeight: 'bold', fontSize: '1.2rem' }}> Override background color of a MenuItem</Typography>
                    <Typography variant="body1" sx={{ my: 3 }} align="left">
                        Uses the fact that when a MenuItem is selected, the classes MuiMenuItem-root and Mui-selected are applied.
                        sx=&#123;&#123; '&.Mui-selected.MuiMenuItem-root' :  &#123; backgroundColor:'rgba(151, 13, 43, 0.15)' &#125;&#125;&#125;<br /><br />
                        On the Dog item, we use sx=&#123;&#123; '&.Mui-selected' :  &#123; backgroundColor:'rgba(151, 13, 43, 0.15)' &#125;&#125;&#125;<br />
                        This targets the root &lt;li&gt; element when the 'Mui-selected' class is applied to the element.
                    </Typography>
